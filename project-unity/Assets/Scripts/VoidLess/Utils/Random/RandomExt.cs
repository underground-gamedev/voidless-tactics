...
namespace VoidLess.Utils.Random
{
    public static class RandomExt
    {
        ...
        /// </summary>
        public static T Choice<T>(this IRandomGenerator rand, IList<T> collection)
        {
        ...
        /// <summary>
        /// Random shuffle any list
        /// </summary>
        public static void Shuffle<T>(this IRandomGenerator rand, IList<T> list)
        {
