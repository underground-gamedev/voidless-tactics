...
namespace Battle
{
    public class AttackClosestTargetAIComponent : AIComponent
    {
        protected override IEnumerator ChooseAction()
        {
            ...
            List<MapCell> attackCircleMapCells = MapMono.AllNeighboursFor(targetCell.X, targetCell.Y);
            ...
            else if (moveCom.MoveAvailable())
            {
                ...
                var path = MapMono.PathfindLayer.Pathfind(mapObj.Cell, target.MapObject.Cell);
